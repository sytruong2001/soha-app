                    ...
                    <div class="content content-full-width">
                        ...
                        <div class="tab-content">
                            <div id="icon-info" class="tab-pane active">
                                <div class="card">
                                    <div class="content">
                                        <form method="POST" action="{{ url('api/admin/change-info') }}" id="AdminInfoForm">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Họ và Tên</label>
                                                        <input type="text" class="form-control" name="name" value="{{$accounts_admin->name}}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="phone" value="{{$accounts_admin->phone}}">
                                                        <span class="text-danger error-text phone_error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-primary" data-dismiss="modal">Sửa thông tin</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div id="icon-account" class="tab-pane">
                                <div class="card">
                                    <div class="content">
                                        <form action="{{ url('api/admin/change-password') }}" method="POST" id="change_pass">
                                            @csrf
            ...
            <div class="col-md-4">
                <div class="card card-user">
                    ...
                    <div class="text-center">
                        <a href="{{ url('/admin/link') }}" ><button class="btn btn-simple"><i class="fa fa-telegram" style="font-size: 20px;"></i></button></a>
